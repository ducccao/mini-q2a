            ...
            <table id="table_quecate" class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tên người dùng trả lời</th>
                ...
                <tbody>
                    ...
                    foreach ($data[0]  as $ans) {
                        echo ' <tr>';
                        echo "<td>$ans[ans_id] </td>";
                        echo "<td>$ans[createdAt] </td>";

                        echo "<td>$ans[user_name] </td>";
                        echo "<td>$ans[que_id] </td>";
                        echo "<td>$ans[is_accepted]                    
                        </td>";
